    ...
    <form id="frm-edit-minit-curai">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <div class="col-12">
                    <textarea class="form-control" name="txtPegawai" rows="5" placeholder="Nyatakan Nama Pegawai Yang Terlibat" required></textarea>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="col-12">
                    <textarea class="form-control" name="txtIsu" rows="5" placeholder="Nyatakan isi / isi penting " required></textarea>
                    </div>
                    </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div class="col-12">
                    <textarea class="form-control" name="txtTindakan" rows="5" placeholder="Nyatakan tindakan seperti keputusan, Mesyuarat dalaman/bengkel dalaman dan lain-lain" required></textarea>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div class="col-12">
                    <textarea class="form-control" name="txtTindakan" id="" rows="5" placeholder="Arahan / Cadangan bagi Tindakan / Keputusan oleh Pengarah/Timbalan Pengarah (Sekiranya dari Timbalan Pengarah, salinan hendaklah diserahkan kepada Pengarah" required></textarea>
                    </div>
                </td>
            </tr>
</td>
